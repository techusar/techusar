...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {/* Popover Chat Prompt */}
      {isOpen && (
        <div className="mb-3 w-80 sm:w-96 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-3 duration-200">
          {/* Header */}
          <div className="bg-emerald-600 text-white p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-semibold text-sm leading-tight">Hafiz Muhammad Usman</h4>
          ...
          {/* Body */}
          <div className="p-4 bg-neutral-50/70 dark:bg-neutral-900/90 text-xs space-y-3">
            <div className="bg-white dark:bg-neutral-800 p-3 rounded-xl rounded-tl-none border border-neutral-200/60 dark:border-neutral-700/60 shadow-2xs space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {[
                ...
                <button
                  ...
                  className="text-[11px] px-2.5 py-1 rounded-full bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 hover:border-emerald-500 transition-colors text-left"
                >
                  {suggestion}
                </button>
              ))}
      ...
      <button
        ...
        className="group relative flex items-center gap-2 px-4 py-3 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg hover:shadow-emerald-600/30 transition-all active:scale-95 duration-200"
      >
